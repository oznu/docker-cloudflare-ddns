...
* `-e CUSTOM="echo '1.1.1.1'"` - Set to any shell command to run them and have the IP pulled from the standard output. This is sometimes useful in some specific usage.
